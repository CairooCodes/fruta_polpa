  ...
  <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
    ...
    <div class="max-w-7xl px-4 pb-8 mx-auto py-8">
      <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <form action="./controllers/edit_servico.php?id=<?php echo $servico['id']; ?>" method="POST" enctype="multipart/form-data" class="relative bg-white rounded-lg shadow">
          <!-- Modal header -->
          ...
          <div class="p-6 space-y-6">
            <div class="grid grid-cols-6 gap-6">
              <input id="id" name="id" type="hidden" value="<?php echo $servico['id']; ?>">
              <div class="col-span-6 sm:col-span-3">
                <label class="block mb-2 text-sm font-medium text-gray-900">Nome</label>
                <input name="name" type="text" value="<?php echo $servico['name']; ?>" id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Nome do Serviço" required="">
              </div>
              <div class="col-span-6 sm:col-span-3">
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <input name="link" type="text" value="<?php echo $servico['link']; ?>" id="link" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Link do Serviço" required="">
              </div>
            </div>
            <div class="col-span-6 sm:col-span-3">
              ...
              <select class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" name="categorie_id">
                <?php foreach ($categories as $categorie) {
                  if ($categorie['id'] == $servicos[0]['categorie_id']) { ?>
            ...
            <textarea name="description" id="description" type="text"><?php echo $servico['description']; ?></textarea>

            <label class="block text-sm font-medium text-gray-900">Texto 1 - Página</label>
            <textarea name="page_text1" id="description2" type="text"><?php echo $servico['page_text1']; ?></textarea>

            <label class="block text-sm font-medium text-gray-900">Texto 2 - Página</label>
            <textarea name="page_text2" id="description3" type="text"><?php echo $servico['page_text2']; ?></textarea>
