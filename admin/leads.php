          ...
          <tbody>
            <?php foreach ($leads as $lead) { ?>
              <tr class="<?php
                ...
                <td class="pl-5 font-semibold"><?php echo $lead['telephone']; ?></td>
                <td class="pl-5 font-semibold"><?php echo $lead['cnpj']; ?></td>
                <td class="pl-5 font-semibold"><?php echo $lead['type']; ?></td>
              </tr>
              <td class="px-6 py-4">
                <a href="./controllers/delete_blog.php?id=<?php echo $lead['id']; ?>" type="button" class="font-medium text-red-600 hover:underline">Excluir</a>
              </td>
            <?php } ?>
          </tbody>
        </table>
