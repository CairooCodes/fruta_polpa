        ...
        <div class="lg:pt-12 pb-12 lg:grid grid-cols-2 mt-2">
            <div class="lg:px-12">
                ...
                <div class="max-w-full mx-auto grid grid-cols-2 pt-8">
                    ...
                    <div class="flex justify-center items-center text-white p-3 lg:rounded-bl-md" style="background-color:#f7640e;">
            ...
            <div class="lg:px-16">
                <div class="max-w-full lg:pt-12 mx-auto grid grid-cols-2">
                    ...
                    <div class="flex justify-center items-center text-white text-center p-3 rounded-tr-md" style="background-color:  #f7640e;">
                ...
                <div class="max-w-full mx-auto grid grid-cols-2">
                    ...
                    <div class="flex justify-center items-center text-white p-3 rounded-bl-md pb-12" style="background-color: #f7640e;">
