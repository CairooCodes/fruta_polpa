    ...
    <div class="mx-auto max-w-7xl px-2 pt-32">
        ...
        <div class="grid lg:grid-cols-4 gap-8">
            ...
            <?php foreach ($servicos as $servico) { ?>
                <a href="<?php echo $URI->base('/servico/' . slugify($servico['name'])); ?>">
                    <div class="mb-8 mt-4 items-center rounded-xl p-2">
                        <img class='rounded-full' src='./admin/uploads/servicos/<?php echo $servico['img']; ?>'>
                    </div>
                </a>
                <!-- <div class="mb-8 mt-4 items-center rounded-xl p-2 shadow-md shadow-blue-200">
                    <div class="mr-3">
                        <img class='lazy rounded-md h-52 w-full object-cover' src='./admin/uploads/servicos/<?php //echo $servico['img']; ?>'>
                    </div>
                    <div>
                        <h1 class="title-font mb-1 text-center text-lg font-bold uppercase h-12 pt-2">
                            <?php //echo $servico['name']; ?>
                        </h1>
                        <div class="flex justify-center">
                            <a href="<?php //echo $URI->base('/servico/' . slugify($servico['name'])); ?>">
                                <button class="shadow-cla-blue mt-4 mb-4 rounded-lg bg-orange-600 px-4 py-1 text-white drop-shadow-md hover:scale-105">
                                    Saiba Mais
                                </button>
                            </a>
                        </div>
