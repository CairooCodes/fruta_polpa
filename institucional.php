            ...
            <div class="lg:pt-4 lg:p-0 lg:p-10 p-5">
                <div class="grid grid-cols-2 gap-4">
                    <div class="mx-auto">
                        ...
                        <p class="text-base font-sans">A qualidade dos produtos "in natura" e congelados De Marchi tem origem nas fazendas do grupo e também dos produtores parceiros. Elas são a garantia de produtos cultivados com muito cuidado e sabor incomparáveis.</p>
                    </div>
                    <!-- Your HTML Structure -->
            ...
            <div class="lg:pt-4 lg:p-0 lg:p-10 p-5">
                <div class="grid grid-cols-2 gap-4">
                    <div class="mx-auto">
                        ...
                        <p class="text-base font-sans">O grupo conta com mais de 3.000 profissionais altamente capacitados e modernos equipamentos para garantir produtos minimamente processados, mantendo toda qualidade e sabor que vem direto do campo.</p>
                    </div>
                    <!-- Your HTML Structure -->
                    <div class="owl-carousel">
                        <div class="item">
