<section class="bg-slate-100 pt-10">
  <div class="max-w-screen-xl px-4 pt-5 mx-auto lg:grid grid-cols-2 lg:space-x-10">
    <div>
      <h1 class="font-sm text-xl text-sky-950 uppercase">
        Deseja ser um Revendedor ou Representante? <br><span class="font-bold lg:text-4xl text-sky-950">PREENCHA O FORMULÁRIO</span>
      </h1>
      <form action="./admin/controllers/add_lead.php" method="POST" class="rounded-lg w-full">
        ...
        <button class="bg-sky-950 hover:bg-gray-500 text-base text-white hover:text-white font-bold py-2 px-4 rounded-md lg:w-full sm:w-80 uppercase">
          Enviar
        </button>
      </form>
    </div>
