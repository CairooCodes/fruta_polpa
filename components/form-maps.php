<section class="bg-yellow-50 lg:py-20">
  <div class="max-w-screen-xl px-4 mx-auto lg:grid grid-cols-2 lg:space-x-10 pt-5">
    <div class="mx-auto rounded w-full px-4" style="background: rgb(252,114,0); background: linear-gradient(15deg, rgba(252,114,0,1) 25%, rgba(255,198,0,1) 100%);">
      <form action="./admin/controllers/add_lead.php" method="post" class="mr-auto lg:p-8 place-self-center pt-5 mb-5 pb-5">
        ...
        <div>
          ...
          <input type="email" name="email" id="email" placeholder="Email@gmail.com" class="mt-1 mb-2 w-full rounded-lg p-3 text-gray-900" required="" />
        </div>
        <div>
          <label class="text-sm font-bold text-white">
            WhatsApp
          </label>
          <input type="text" name="telephone" id="telephone" placeholder="(99) 9 9999-9999" class="mt-1 mb-2 w-full rounded-lg p-3 text-gray-900" required="" />
        </div>
        <div>
          <label class="text-sm font-bold text-white">
            CNPJ
          </label>
          <input type="text" name="cnpj" id="cnpj" placeholder="Da Empresa ou Pessoa Física" class="mt-1 mb-2 w-full rounded-lg p-3 text-gray-900" required="" />
        </div>
        <div>
          <label class="text-sm font-bold text-white">
            Mensagem
          </label><br>
          <textarea name="description" id="description" placeholder="Assunto..." rows="2" cols="50" class="mt-1 mb-2 w-full rounded-lg p-3 text-gray-900" required=""></textarea>
        </div>
