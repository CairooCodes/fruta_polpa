<footer class="mt-8 shadow-inner bg-color1">
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class=>
      ...
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
        <div>
          <p class="font-semibold text-white border-b-2">INSTITUCIONAL</p>
          ...
          <div class="grid grid-cols-2 gap-2">
            ...
            <a class="hover:opacity-75" href="./ESTATUTOLIVRO.pdf">
              Industrial
            </a>
          </div>
          </nav>
        ...
        <div>
          <p class="font-semibold text-white border-b-2">PRODUTOS</p>
          <nav class="mt-4 flex justify-center flex-col space-y-2 text-white">
            <div class="grid grid-cols-3 gap-2 text-center">
              <?php foreach ($products as $product) { ?>
                <a class="hover:opacity-75" href="<?php echo $URI->base('product/' . slugify($product['name'])); ?>">
        ...
        <div>
          ...
          <nav class="mt-4 flex flex-col space-y-2 text-white">
            ...
            </a><a class="hover:opacity-75" href="#">
              Denúcia
            </a>
        </div>
        <div>
          <p class="font-semibold text-white border-b-2">REDES SOCIAIS</p>
          <nav class="mt-4 flex flex-col space-y-2 text-white">
