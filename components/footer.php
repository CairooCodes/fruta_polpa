...
<footer class="w-full text-gray-700 bg-white body-font border-t pt-16">
  <div class="max-w-screen-xl px-4 flex flex-col flex-wrap py-12 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
    <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
      <div>
        <a href="https://frutapolpa.com.br/home.php" class="flex justify-center">
          <img src="https://frutapolpa.com.br./assets/img/logo.png" class="logo" loading="lazy" alt="Fruta Polpa" />
        </a>
      </div>
    ...
    <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4 mt-10 -mb-10 text-left md:pl-20 md:mt-0 md:text-left">
      <div class="">
        ...
        <div class="mb-10 list-none">
          <li class="mt-3">
            <a href="https://frutapolpa.com.br/institucional" class="text-gray-600 cursor-pointer hover:text-orange-500">
              Institucional
            </a>
          </li>
          <li class="mt-3">
            <a href="https://frutapolpa.com.br/trabalhe-conosco" class="text-gray-600 cursor-pointer hover:text-orange-500">
              Trabalhe Conosco
            </a>
          </li>
        </div>
      ...
      <div>
        ...
        <div class="mb-10 list-none">
          <li class="mt-3">
            <a href="https://frutapolpa.com.br/polpas-tradicionais" class="text-gray-600 cursor-pointer hover:text-orange-500">
              Linha Tradicional
            </a>
          </li>
          <li class="mt-3">
            <a href="https://frutapolpa.com.br/polpas-mixs" class="text-gray-600 cursor-pointer hover:text-orange-500">
              Linha Mix
            </a>
          </li>
          <li class="mt-3">
      ...
      <div>
        ...
        <div class="mb-10 list-none">
          <li class="mt-3">
            <a href="https://frutapolpa.com.br/contato" class="text-gray-600 cursor-pointer hover:text-orange-500">
              Fale Conosco
          <li class="mt-3">
            <a href="https://frutapolpa.com.br/trabalhe-conosco" class="text-gray-600 cursor-pointer hover:text-orange-500">
