<header class="w-full shadow z-10 bg-white lg:hidden">
    ...
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
      ...
      <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
        <ul class="flex items-center flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
          ...
          <li>
            <a href="https://www.tiktok.com/@boom.empresarial">
              <svg class="h-9 w-7 mt-3 -ml-3" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
