...
?>
<header class="w-full">
    <div class="hidden bg-orange-500 sm:block py-1">
        <div class="mx-auto flex max-w-6xl justify-between">
            <div class="flex justify-between items-center space-x-2">
                ...
                <span class="text-sm text-white">Outras Fruta Polpa</span>
            </div>
            <!-- <div class="flex space-x-4 items-center">
                ...
                <a href="<?php echo $URI->base("admin/login.php"); ?>">
                    <span class="text-sm font-bold text-white">Entrar</span>
                </a>
            </div> -->
            <div class="flex items-center">
                <div>
                    <img class="mr-2 nuvem-icon" width="50" src="<?php echo $URI->base('/assets/img/tempo.png') ?>">
                </div>
                <div class="hidden md:block text-white font-semibold text-sm">
        ...
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
            ...
            <div class="items-center justify-center hidden w-full lg:flex lg:w-auto lg:order-1 py-1.5 mt-2" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    <li class="py-2">
                        <a href="<?php echo $URI->base("home.php"); ?>" class="block py-2 pl-3 pr-4 text-orange-500 rounded lg:p-0" aria-current="page">Home</a><img src="./assets/img/laranja.png" class="hover-image" alt="Imagem 1">
                    </li>
                    <li class="py-2">
                        <a href="<?php echo $URI->base("quemsomos"); ?>" class="block py-2 pl-3 pr-4 text-orange-500 rounded lg:p-0" aria-current="page">Quem Somos</a><img src="./assets/img/laranja.png" class="hover-image" alt="Imagem 1">
                    </li>
                    ...
                    <li class="py-2">
                        <a href="<?php echo $URI->base("blog"); ?>" class="block py-2 pl-3 pr-4 text-orange-500 rounded lg:p-0" aria-current="page">Blog</a><img src="./assets/img/laranja.png" class="hover-image" alt="Imagem 1">
                    </li>
