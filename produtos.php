    ...
    <div class="grid lg:grid-cols-4 gap-8">
      <?php foreach ($potes as $pote) { ?>
        <div>
          ...
          <div class="flex justify-center mt-4">
            <a href="<?php echo ('https://frutapolpa.com.br/polpa/' . slugify($pote['name'])); ?>" style="background: rgb(252,114,0); background: linear-gradient(15deg, rgba(252,114,0,1) 25%, rgba(255,198,0,1) 100%);" class="text-white border-2 border-white bg-white rounded-full font-semibold text-lg px-5 py-2 text-center hover:bg-orange-600 hover:text-black"><?php echo $pote['name']; ?></a>
          </div>
        </div>
  ...
  <div class="mx-auto max-w-7xl px-2 pt-10">
    ...
    <div class="grid lg:grid-cols-4 gap-8">
      <?php foreach ($frutas as $fruta) { ?>
        <div>
          <div class="mb-8 mt-4 items-center rounded-xl p-2">
            <img loading="lazy" src='./admin/uploads/polpas/<?php echo $fruta['img']; ?>'>
          </div>

          <div class="flex justify-center mt-4">
            <a href="<?php echo ('https://frutapolpa.com.br/polpa/' . slugify($fruta['name'])); ?>" style="background: rgb(252,114,0); background: linear-gradient(15deg, rgba(252,114,0,1) 25%, rgba(255,198,0,1) 100%);" class="text-white border-2 border-white bg-white rounded-full font-semibold text-lg px-5 py-2 text-center hover:bg-orange-600 hover:text-black"><?php echo $fruta['name']; ?></a>
          </div>
        </div>
