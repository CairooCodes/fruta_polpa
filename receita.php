            ...
            <div class="image">
                <div class="mt-4 rounded-xl p-2 shadow-md shadow-blue-200" style="width: 400px; height: 350px;">
                    <div class="flex justify-center">
                        <?php echo "<img class='lazy rounded-md h-full w-52 object-cover mt-14' style='width: 350px; height: 250px;' src=" . $URI->base('/admin/uploads/receitas') . '/' . $receitas['img'] . '>' ?>
                    </div>
                </div>
            </div>
            <div class="description">
                <h2>
                    <?php echo $receitas['description']; ?>
                </h2>
            </div>
        </div>
    </section>
