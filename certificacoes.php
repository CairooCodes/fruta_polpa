...
<body>
    ...
    <section class="mx-auto max-w-7xl px-2 pt-10 pb-10">
        ...
        <div class="text-justify px-4 mt-16">
            <div class="">
                <!-- <div class="mb-10">
                ...
                <div class="mb-10">
                    ...
                    <p class="lg:text-base text-base py-4">
                    ...
                    <div class="text-center">
                        ...
                        <div class="cert-description">
                            <h1 class="lg:text-2xl text-xl text-center p-5">
                                <span style="letter-spacing: 0.5px" class="font-black bg-clip-text bg-gradient-to-r from-color1 to-color1 text-color1">Natureza e inovação para o desenvolvimento sustentável
                            </h1>
                            <p class="pb-6">Produzir energia renovável é bom para o meio ambiente, para a economia e para as pessoas</p>
