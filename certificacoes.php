...
<body>
    ...
    <section class="mx-auto max-w-7xl px-2 pt-10 pb-10">
        ...
        <div class="text-justify lg:mt-16 mt-5">
            <div class="">
                <!-- <div class="mb-10">
                ...
                <div class="mb-10 fade-in-up">
                    <div class="px-4 py-3">
                        ...
                        <p class="lg:text-base lg:text-base text-xl py-6 lg:py-8 lg:px-24">
                    ...
                    <div class="px-10 fade-in-up border-y border-gray-300 py-2">
                        <!-- <button style="background: rgb(252,114,0); background: linear-gradient(15deg, rgba(252,114,0,1) 25%, rgba(255,198,0,1) 100%);" class="saiba-mais text-white border-2 border-white bg-white rounded-full font-semibold text-lg px-5 py-2 text-center hover:bg-orange-600 hover:text-black">Saiba Mais</button> -->
                        <!-- <div class="cert-description"> -->
                        <div class="lg:pl-5">
                            <h2 class="py-6 text-gray-500 text-xl lg:pl-16 lg:text-start text-center">Vantagens da energia renovável</h2>
                            <h1 class="lg:pl-16 lg:text-start text-center">
                                ...
                                <pl class="text-4xl font-semibold bg-clip-text bg-gradient-to-r from-color1 to-color1 text-color1"> desenvolvimento</p>
                                    <pl class="text-4xl font-semibold bg-clip-text bg-gradient-to-r from-color1 to-color1 text-color1">sustentável</p>
                            </h1>
                            <div class="lg:flex lg:justify-center lg:pl-44">
                        ...
                        <div class="lg:grid grid-cols-3 gap-8 pt-10 text-center">
                            <div>
